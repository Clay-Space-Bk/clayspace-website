...
const SingleProductCard = ({ product }: { product: ProductDT }) => {
    ...
    const handleAdd = () => {
        addToCart({ id: product.id, title: product.title, price: product.price, image: product.image, link: product.link, quantity: 1 });
    };
        ...
        <div className="tp-product-item mb-30">
            <div className="tp-product-item-thumb">
                ...
                <div className="tp-product-item-btn">
                    <button className="tp-action-btn" type="button" onClick={handleAdd}>
                        Add to cart
                    </button>
                </div>
            </div>
