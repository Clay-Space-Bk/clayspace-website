    ...
    return (
        ...
        >
            ...
            <div style={{ position: "relative", height: 320, flex: "none", overflow: "hidden", background: "#FBEEE1" }}>
                ...
                {/* white organic base that flows into the form (kept low, below the text) */}
            ...
            {/* form body fills the remaining height */}
            <div style={{ flex: 1, display: "flex", flexDirection: "column", padding: "40px 44px 40px", overflowY: "auto" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 30 }}>
                    <span style={{ fontSize: "1.7rem", fontWeight: 800, color: "#1F1A17", letterSpacing: "-.02em" }}>Sign in</span>
                    <button type="submit" aria-label="Sign in" className="cs-login-arrow"
                ...
                {/* links pinned to the bottom of the full-height panel */}
                <div style={{ marginTop: "auto", display: "flex", alignItems: "center", justifyContent: "space-between", paddingTop: 30 }}>
                    <Link href="/register" className="cs-login-link" style={linkStyle}>Sign up</Link>
                    <Link href="#" className="cs-login-link" style={linkStyle}>Forgot Password</Link>
                </div>
            </div>
            ...
            <style dangerouslySetInnerHTML={{
                __html:
                    ...
                    ".cs-login-panel{width:min(94vw,480px);box-sizing:border-box}" +
                    "@media(max-width:600px){.cs-login-panel{width:100% !important}}",
            }} />
        </form>
    );
};
