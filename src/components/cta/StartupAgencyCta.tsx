import ctaBg from '../../../public/assets/img/clayspace/products/product-11.jpg';
                ...
                <div className="row">
                    <div className="col-lg-12">
                        <div className="st-cta-wrapper text-center z-index-1">
                            <h3 className="tp-section-title-playfair mb-40 tp_fade_anim" data-delay=".3">COME MAKE <br /> <span>SOMETHING</span></h3>
